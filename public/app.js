    ...
    <body>
        ...
        <div id="login-screen">
            <div class="login-container">
                <img src="../turnkey.png" alt="Logo" class="logo" />
                <h3>HSE Degital System</h3>
                <form id="login-form">
        ...
        <div id="app-wrapper" style="display: none">
            ...
            <main id="content">
                <div class="mobile-header">
                    ...
                    ><span>HSE System</span>
                </div>

                <section id="Dashboard" class="page-section">
                    <h2><i class="fas fa-tachometer-alt"></i> لوحة التحكم</h2>
                    <p>مرحباً بك في نظام إدارة التصاريح والملاحظات.</p>
                    <p>الرجاء استخدام القائمة الجانبية للتنقل.</p>
                    <div class="slogan">
                        <p>"بنأسس صح... عشان يدوم الأمن."</p>
                    </div>
                </section>
                            ...
                            >
                                <div>
                                    <input
                                        ...
                                        checked
                                    />
                                    <label for="resp-elsewedy">السويدي</label>
                                </div>
                                <div>
                                    <input
                                        type="radio"
                ...
                <section
                    ...
                    style="display: none"
                >
                    <h2><i class="fas fa-tasks"></i> متابعة التصاريح</h2>
                    <div class="filter-controls">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label for="monitor-from-date">من تاريخ:</label
                                ><input type="date" id="monitor-from-date" />
                            </div>
                            <div class="form-group">
                                <label for="monitor-to-date">إلى تاريخ:</label
                        ...
                        <div class="form-row filter-options">
                            <div class="form-group checkbox-group">
                                <input
                                    type="checkbox"
                                    id="monitor-open-only"
                                /><label for="monitor-open-only"
                                    >عرض المفتوحة فقط</label
                                >
                            </div>
                            <button
                                type="button"
                ...
                >
                    ...
                    <div class="kpi-selection-area">
                        <div class="form-row">
                            <div class="form-group">
                                <label for="kpi-employee-select"
                                    >اختر الموظف لتقييمه:</label
                                >
                                <select id="kpi-employee-select">
                    ...
                    <!-- 2. KPI Form Area (Dynamically built) -->
                    <form id="kpi-form-area">
                        <div id="kpi-list-container">
                            <!-- JS will build the KPI cards/rows here -->
                            <p>
                                الرجاء اختيار الموظف وفترة التقييم لعرض الـ KPIs
                                الخاصة به.
                            </p>
                        </div>
                    ...
                    <form id="ppe-form" class="app-form">
                        ...
                        >
                            ...
                            >
                                <div class="form-group">
                                    <label
                                        for="ppe-recipient-employee"
                                        class="required"
                                        >اسم الموظف:</label
                                    >
                                    <select
                                        id="ppe-recipient-employee"
                                    ></select>
                                </div>
                            </div>
                ...
                >
                    ...
                    <form id="training-form" class="app-form">
                        ...
                        <div id="trn-emp-group">
                            <div class="form-group">
                                <label for="trn-emp-select">اسم الموظف:</label>
                                <select id="trn-emp-select"></select>
                            </div>
                            <div class="form-group checkbox-group">
                        ...
                        <div id="trn-cont-group" style="display: none">
                            <div class="form-group">
                                ...
                                <select id="trn-cont-company"></select>
                            </div>
                            <div class="form-group">
